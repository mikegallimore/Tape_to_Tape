...
in_plays = 'files/exported/' + set_season[:4] + '0' + set_game + '_plays.csv'

### Creates a variable that locates the file of the exported roster downloaded from tapetotapetracker.com
roster = 'files/exported/' + set_season[:4] + '0' + set_game + '_roster.csv'
...
out_plays = 'files/processed/' + set_season + '_' + set_game + '_processed.csv'
