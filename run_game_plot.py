...
import plot_game_density_shots
import plot_game_scatter_shots
import argparse
...
plot_game_density_shots.plot_game_density_shots(args.season_ID, args.game_ID)
plot_game_scatter_shots.plot_game_scatter_shots(args.season_ID, args.game_ID)
