...
### creates a function with arguments to pass through from run_game.py
def parse_game(season_ID, game_ID):
    ...
    in_plays = 'files/exported/' + season_ID[:4] + '0' + game_ID + '_plays.csv'
    roster = 'files/exported/' + season_ID[:4] + '0' + game_ID + '_roster.csv'
    ...
    out_plays = 'files/processed/' + season_ID + '_' + game_ID + '_processed.csv'
    ...
    with open(out_plays, 'w', newline='') as fileout:
        ...
        with open(in_plays, 'r') as filein:
            ...
            for row in csvReader[1:]:
                ...
                season_last = seasongamenumber[:4]
                ...
                json_url = "http://statsapi.web.nhl.com/api/v1/game/" + season_last + "0" + gamenumber + "/feed/live"            
